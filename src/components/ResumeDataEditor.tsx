...
export const ResumeDataEditor: React.FC<ResumeDataEditorProps> = ({
  ...
  const wrapperClass = isDark 
    ...
    : "bg-white/90 backdrop-blur-md border border-white/70 rounded-3xl shadow-[0_10px_40px_rgba(99,102,241,0.03)] flex flex-col h-full overflow-hidden select-none text-slate-700";
  ...
  const tabBtnInactiveClass = isDark
    ...
    : "bg-white hover:bg-slate-50 border border-slate-200 text-slate-600 hover:text-indigo-650 hover:border-indigo-350 shadow-2xs font-semibold transition-all duration-200";
  ...
  const contentAreaClass = isDark
    ...
    : "p-6 flex-1 overflow-y-auto text-slate-700 select-text";
  ...
  const sectionHeadingClass = isDark
    ...
    : "text-sm font-bold text-slate-700 tracking-wider uppercase mb-2 flex items-center gap-1.5 font-mono";
  ...
  const inputElemClass = isDark
    ...
    : "w-full bg-white border border-slate-200 hover:border-slate-350 rounded-xl px-3.5 py-2.5 text-sm text-slate-800 focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 placeholder:text-slate-400 shadow-2xs transition-all duration-200";
  ...
  const textareaClass = isDark
    ...
    : "w-full bg-white border border-slate-200 hover:border-slate-350 rounded-xl p-3.5 text-sm text-slate-800 focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 leading-relaxed font-sans shadow-2xs transition-all duration-200";

  const recordCardClass = isDark
    ? "p-4 bg-zinc-950 rounded-xl border border-zinc-805 space-y-3 relative group"
    : "p-5 bg-slate-55/65 backdrop-blur-xs rounded-2xl border border-slate-100 space-y-4 relative group shadow-2xs hover:shadow-xs transition-all duration-200";

  const recordCardProjClass = isDark
    ? "p-4 bg-zinc-950 rounded-xl border border-zinc-805 space-y-4 relative"
    : "p-5 bg-slate-55/65 backdrop-blur-xs rounded-2xl border border-slate-100 space-y-4 relative shadow-2xs hover:shadow-xs transition-all duration-200";
  ...
  const inputNestedClass = isDark
    ...
    : "w-full bg-white border border-slate-200 hover:border-slate-350 rounded-xl px-3 py-2 text-xs text-slate-800 focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 shadow-2xs transition-all duration-200";

  const labelNestedClass = isDark
    ? "block text-[11px] font-semibold text-zinc-500 mb-0.5 font-sans"
    : "block text-[11px] font-bold text-neutral-500 mb-0.5 font-sans";
