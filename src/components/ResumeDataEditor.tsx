...
export const ResumeDataEditor: React.FC<ResumeDataEditorProps> = ({
  ...
  const wrapperClass = isDark 
    ...
    : "bg-white border border-slate-200 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col h-full overflow-hidden select-none text-slate-800";
  ...
  const tabHeaderClass = isDark
    ...
    : "border-b border-slate-100 bg-slate-50/50 p-3 flex flex-wrap gap-2 overflow-x-auto no-print";

  const tabBtnInactiveClass = isDark
    ? "bg-zinc-900 text-zinc-400 hover:text-zinc-200 hover:bg-zinc-850"
    : "bg-white hover:bg-slate-50 border border-slate-200 text-slate-500 hover:text-slate-800 hover:border-slate-300 shadow-sm font-bold transition-all duration-200";
  ...
  const resetBtnClass = isDark
    ...
    : "ml-auto flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold text-slate-500 hover:bg-slate-100 hover:text-slate-800 border border-slate-200 hover:border-slate-300 shadow-sm transition-all duration-200 font-sans cursor-pointer";

  const contentAreaClass = isDark
    ? "p-5 flex-1 overflow-y-auto text-zinc-300 select-text"
    : "p-6 flex-1 overflow-y-auto text-slate-800 select-text bg-white";
  ...
  const sectionHeadingClass = isDark
    ...
    : "text-sm font-black text-slate-800 tracking-wider uppercase mb-2 flex items-center gap-1.5 font-mono";

  const labelTextClass = isDark
    ? "block text-xs font-semibold text-zinc-400 mb-1"
    : "block text-xs font-bold text-slate-500 mb-1";
  ...
  const inputElemClass = isDark
    ...
    : "w-full bg-slate-50/50 border border-slate-200 hover:border-slate-300 rounded-xl px-3.5 py-2.5 text-sm text-slate-800 focus:outline-none focus:ring-4 focus:ring-slate-100 focus:border-slate-400 placeholder:text-slate-400 shadow-sm transition-all duration-200";
  ...
  const textareaClass = isDark
    ...
    : "w-full bg-slate-50/50 border border-slate-200 hover:border-slate-300 rounded-xl p-3.5 text-sm text-slate-800 focus:outline-none focus:ring-4 focus:ring-slate-100 focus:border-slate-400 leading-relaxed font-sans shadow-sm transition-all duration-200";

  const recordCardClass = isDark
    ? "p-4 bg-zinc-950 rounded-xl border border-zinc-805 space-y-3 relative group"
    : "p-5 bg-white rounded-2xl border border-slate-200 space-y-4 relative group shadow-sm hover:shadow-md hover:border-slate-300 transition-all duration-200";

  const recordCardProjClass = isDark
    ? "p-4 bg-zinc-950 rounded-xl border border-zinc-805 space-y-4 relative"
    : "p-5 bg-white rounded-2xl border border-slate-200 space-y-4 relative shadow-sm hover:shadow-md hover:border-slate-300 transition-all duration-200";
  ...
  const inputNestedClass = isDark
    ...
    : "w-full bg-slate-50/50 border border-slate-200 hover:border-slate-300 rounded-xl px-3 py-2 text-xs text-slate-800 focus:outline-none focus:ring-4 focus:ring-slate-100 focus:border-slate-400 shadow-sm transition-all duration-200";

  const labelNestedClass = isDark
    ? "block text-[11px] font-semibold text-zinc-500 mb-0.5 font-sans"
    : "block text-[11px] font-bold text-slate-500 mb-0.5 font-sans";
