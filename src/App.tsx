              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-3">
                  <button
                    ...
                    className={`w-full flex items-center justify-center gap-3 py-3.5 px-4 rounded-xl border font-extrabold text-sm transition-all shadow-sm cursor-pointer hover:-translate-y-0.5 active:scale-95 ${isDark
                        ? "bg-zinc-900 border-zinc-700 hover:bg-zinc-800 text-white shadow-black/20"
                        : "bg-white border-slate-200 hover:bg-slate-50 text-slate-800 hover:border-slate-300 hover:shadow-md"
                      }`}
                  >
